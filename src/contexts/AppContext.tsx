    ...
    const sampleCustomers = [
      {
        ...
        address: 'Riyadh, Al-Narjes District, Saudi Arabia',
        cars: [
          {
            id: generateId(),
            customerId: '',
    ...
    const sampleOrders = [
      {
        ...
        assignedTechnician: 'Ahmad Al-Rashid',
        partsUsed: [],
        laborCost: 50,
        notes: 'Customer requested synthetic oil - Premium service',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        ...
        description: 'Brake System Inspection and Front Tire Replacement',
        status: 'in_progress' as const,
        priority: 'high' as const,
        assignedTechnician: 'Mohammed Al-Saudi',
        partsUsed: [],
        laborCost: 150,
        notes: 'Complete brake system check required before tire installation',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ];
