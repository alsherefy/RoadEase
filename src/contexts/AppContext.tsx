    ...
    const sampleCustomers = [
      {
        ...
        address: 'Riyadh, Al-Narjes District',
        cars: [
          {
            id: generateId(),
            customerId: '',
    ...
    const sampleOrders = [
      {
        ...
        assignedTechnician: 'Maintenance Technician',
        partsUsed: [],
        laborCost: 50,
      ...
      },
      {
        ...
        description: 'Brake Inspection and Tire Replacement',
        status: 'in_progress' as const,
        priority: 'high' as const,
        assignedTechnician: 'Maintenance Technician',
        partsUsed: [],
        laborCost: 150,
        notes: 'Requires detailed brake inspection',
        createdAt: new Date(),
        updatedAt: new Date(),
      },
    ];
